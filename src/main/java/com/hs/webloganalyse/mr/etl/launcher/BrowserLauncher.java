...
import com.hs.webloganalyse.mr.analyse.BrowserMapper;
import com.hs.webloganalyse.mr.analyse.BrowserReducer;
...
public class BrowserLauncher {
	...
	public static void main(String[] args)
		...
		Job job = Job.getInstance(conf, GlobalConstants.BROWSER_TASK);

		job.setJarByClass(BrowserLauncher.class);
		...
		String outputpath = GlobalConstants.BROWSER_PATH__PREFIX + currentDate + "/";
		// 指定job的输入原始文件所在目录
