...
import com.hs.webloganalyse.mr.etl.SessionReducer;
...
public class SessionMRLauncher {
	...
	public static void main(String[] args)
		...
		Job job = Job.getInstance(conf,GlobalConstants.SESSION_TASK);

		job.setJarByClass(SessionMRLauncher.class);
		...
		String outputpath = GlobalConstants.SESSIONDATA_PATH_PREFIX + currentDate + "/";
		// 指定job的输入原始文件所在目录
